...
if (mysqli_num_rows($itemresult) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($itemresult)) {
        ...
        if ($row['beat_basic_amount'] != "") {
            ...
            ?>
            <li>
            <a class="download add-to-cart" data-tippy="Download" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  href="./admin/Files/beat/<?= $freeFile; ?>" download="<?= $row['beat_name']; ?>">
