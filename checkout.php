                            ...
                            <form action="checkout_handler.php" method="POST">
                                ...
                                <div class="checkbox-form">
                                    ...
                                    <div class="coupon-accordion">
                                        ...
                                        <h3>Do you wish to change your email, for receiving products? <span id="showemail">Click here to change your email</span></h3>
                                    ...
                                    <table class="table">
                                        ...
                                        <tfoot class="checkout-total">
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong>$<span class="amount"><?=number_format($amount,2);?></span></strong></td>
                                                
                                            </tr>
                                            <input type="text" class="amount-input" hidden name="amount" value="">
