                            ...
                            <div class="contact-wrap">
                                <div class="contact-info text-white" data-bg-image="assets/images/contact/1-1-370x500.jpg">
                                    ...
                                    <ul class="contact-list">
                                        ...
                                        <li>
                                            ...
                                            <a href="mailto://alabahmusic@gmail.com">alabahmusic@gmail.com</a>
                                        </li>
                                ...
                                <form id="contact-form" class="contact-form" action="./callback.php" method="POST">
                                    ...
                                    <div class="form-field mb-5">
                                        <textarea name="con_message" id="con_message" placeholder="Message" class="textarea-field" style="resize: none;line-height:25px;"></textarea>
                                    </div>
                                    <div class="contact-button-wrap">
                                        <button type="submit" value="submit" class="btn btn btn-custom-size xl-size btn-pronia-primary" name="sendmessage">Send Message <i class="pe-7s-mail"></i></button>
