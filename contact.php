                    ...
                    <div class="contact-wrap">
                        <div class="contact-info text-white" data-bg-image="assets/images/contact/1-1-370x500.jpg">
                            ...
                            <ul class="contact-list">
                                <li>
                                    <a href="tel://+234 9062 325092">+234 9062 325092</a>
                                </li>
                                <li>
                                    <a>doperecords2016@gmail.com</a>
                                </li>
                        ...
                        <form id="contact-form" class="contact-form" action="./callback.php" method="POST">
                            <div class="group-input">
                                <div class="form-field me-lg-30 mb-35 mb-lg-0">
                                    <input type="text" name="con_firstName" id="con_firstName" placeholder="First Name*"
                                        class="input-field" autocomplete="off">
                                </div>
                                <div class="form-field mb-35">
                                    <input type="text" name="con_lastName" id="con_lastName" placeholder="Last Name*"
                                        class="input-field" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-field mb-5">
                                <textarea name="con_message" id="con_message" placeholder="Message"
                                    class="textarea-field" style="resize: none;line-height:25px;"></textarea>
                            </div>
                            <div class="contact-button-wrap">
                                <button type="submit" value="submit"
                                    class="btn btn btn-custom-size xl-size btn-pronia-primary" name="sendmessage">Send
                                    Message <i class="pe-7s-mail"></i></button>
