                        ...
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 align-self-center">
                                <div class="slide-content text-black">
                                    ...
                                    <p class="short-desc"><?=$beatWriteUp;?></p>
                                    <div class="btn-wrap">
                                        <a class="btn btn-custom-size xl-size btn-pronia-primary" href="beatstore.php">Buy Now <i class="fa fa-shopping-cart text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="inner-img">
                                    <div class="scene fill">
                                        <div class="expand-width" data-depth="0.2">
                                            ...
                                            <img src="./admin/Files/beat/<?=$beatImages;?>" alt="Inner Image"   style="object-fit:cover;width:100%;height:500px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 align-self-center">
                                <div class="slide-content text-black">
                                    ...
                                    <h2 class="title">From The Pro's</h2>
                                    <p class="short-desc"><?=$sampleWriteUp?></p>
                                    <div class="btn-wrap">
                                        <a class="btn btn-custom-size xl-size btn-pronia-primary" href="samplepack.php">Buy Now <i class="fa fa-shopping-cart text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-0 order-1 order-lg-2">
                                <div class="inner-img">
                                    <div class="scene fill">
                                        <div class="expand-width" data-depth="0.2">
                                            ...
                                            <img src="./admin/Files/sample/<?=$sampleImages;?>" alt="Inner Image"   style="object-fit:cover;width:100%;height:500px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 align-self-center">
                                <div class="slide-content text-black">
                                    ...
                                    <h2 class="title">From The Pro's</h2>
                                    <p class="short-desc"><?=$lyricsWriteUp;?></p>
                                    <div class="btn-wrap">
                                        <a class="btn btn-custom-size xl-size btn-pronia-primary" href="lyricsstored.php">Buy Now <i class="fa fa-shopping-cart text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-0 order-1 order-lg-2">
                                <div class="inner-img">
                                    <div class="scene fill">
                                        <div class="expand-width" data-depth="0.2">
                                            ...
                                            <img src="./admin/Files/lyrics/<?=$lyricsImages;?>" alt="Inner Image"   style="object-fit:cover;width:100%;height:500px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 align-self-center">
                                <div class="slide-content text-black">
                                    ...
                                    <h2 class="title">From The Pro's</h2>
                                    <p class="short-desc"><?=$songWriteUp;?></p>
                                    <div class="btn-wrap">
                                        <a class="btn btn-custom-size xl-size btn-pronia-primary" href="songhub.php">Buy Now <i class="fa fa-shopping-cart text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-0 order-1 order-lg-2">
                                <div class="inner-img">
                                    <div class="scene fill">
                                        <div class="expand-width" data-depth="0.2">
                                            ...
                                            <img src="./admin/Files/song/<?=$songImages;?>" alt="Inner Image"   style="object-fit:cover;width:100%;height:500px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                ...
                <ul class="nav product-tab-nav tab-style-1" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="active" id="<?=$selector;?>-all-tab" data-bs-toggle="tab" href="#<?=$selector;?>-all" role="tab" aria-controls="<?=$selector;?>-all" aria-selected="true">
                           All
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a id="<?=$selector;?>-Free-tab" data-bs-toggle="tab" href="#<?=$selector;?>-Free" role="tab" aria-controls="<?=$selector;?>-Free" aria-selected="false">
                            Free
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a id="latest-tab" data-bs-toggle="tab" href="#<?=$selector;?>-Premium" role="tab" aria-controls="<?=$selector;?>-Premium" aria-selected="false">
                            Premium
                        </a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="<?=$selector;?>-all" role="tabpanel" aria-labelledby="<?=$selector;?>-all-tab">
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    ?>
                                        <div class="col-xl-3 col-md-4 col-sm-6">
                                            ...
                                            <div class="product-item " data-type="beat" data-id="<?=$beatId;?>">
                                                ...
                                                <div class="product-img">
                                                    <a data-bs-toggle="modal" class="beat" data-bs-target="#quickModal" style="cursor:pointer;">
                                                        ...
                                                        ?>
                                                            <span class="btn btn-success position-absolute m-1 btn-sm"><?= $row['beat_category']; ?></span>
                                                        <?php
                                                        } else {
                                                            
                                                        ?>
                                                            <span class="btn btn-warning text-white position-absolute m-1 btn-sm"><?= $row['beat_category']; ?></span>
                                                        <?php
                                                        }
                                                        ?>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <?php
                                                                if($row['beat_basic_amount']!=""){
                                                                   ...
                                                                   <li>
                                                                <a class="add-to-cart " data-tippy="Add to cart" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  data-name="<?= $row['beat_name'] ?>" data-type="Beat" data-image="<?= $row['beat_image']; ?>" data-price="<?= $price; ?>" data-id="<?=$row['beat_id'];?>">
                    ...
                    <div class="tab-pane fade" id="<?=$selector;?>-Free" role="tabpanel" aria-labelledby="<?=$selector;?>-Free-tab">
                    <div class="product-item-wrap row">
                            <?php
                            $location = "beat";
                            if(isset($_GET["Search"])){
                                        ...
                                        <div class="product-item " data-type="beat" data-id="<?=$beatId;?>">
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-add-action">
                                                    <ul>
                                                        <li>
                                                            <a data-tippy="Play" class="play" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder" data-id="<?=$beatId?>" >
                                                                <i class="entypo-icon-controller-play"></i>
                                                            </a>
                                                        </li>
                                                        <li class="quuickview-btn" data-bs-toggle="modal" data-bs-target="#quickModal">
                    ...
                    <div class="tab-pane fade" id="<?=$selector;?>-Premium" role="tabpanel" aria-labelledby="<?=$selector;?>-Premium-tab">
                    <div class="product-item-wrap row">
                            <?php
                            $location = "beat";
                                        ...
                                        <div class="product-item " data-type="beat" data-id="<?=$beatId;?>">
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-add-action">
                                                    <ul>
                                                        <li>
                                                            <a data-tippy="Play" class="play" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-id="<?=$beatId?>" data-tippy-theme="sharpborder">
                                                                <i class="entypo-icon-controller-play" ></i>
                                                            </a>
                                                        </li>
                                                        <li class="quuickview-btn" data-bs-toggle="modal" data-bs-target="#quickModal">
            ...
            <ul class="nav product-tab-nav tab-style-1" id="myTab" role="tablist">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="product-item-wrap row">
                            ...
                            <audio ></audio>
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item " data-type="<?=$location;?>">
                                        <input type="text" hidden id="beat-id" value="<?= $row['sample_id']; ?>">
                                        ...
                                        <div class="product-img">
                                            <a data-bs-toggle="modal" class="beat" data-bs-target="#quickModal" style="cursor:pointer;">
                                                ...
                                                <img class="primary-img" src="./admin/Files/<?=$location;?>/<?= $row['sample_image']; ?>" alt="Product Images">
                                                <img class="secondary-img" src="./admin/Files/<?=$location;?>/<?= $row['sample_image']; ?>" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                                <ul>
                                                <li hidden>
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="shop.html"><?= $row['sample_name']; ?></a>
                    ...
                    <div class="product-item-wrap row">
                            ...
                            <audio ></audio>
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item " data-type="<?=$selector;?>" data-id="<?=$sampleId;?>">
                                        <input type="text" hidden id="beat-id" value="<?= $row['sample_id']; ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <ul class="nav product-tab-nav tab-style-1" id="myTab" role="tablist">
                ...
                <div class="tab-content" id="myTabContent" id="<?=$selector;?>">
                    <div class="tab-pane fade show active" id="<?=$selector;?>-all" role="tabpanel" aria-labelledby="<?=$selector;?>-all-tab">
                        <div class="product-item-wrap row">
                            <?php
                            $location = "lyrics";
                            ...
                            <audio ></audio>
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item " data-type="<?=$selector;?>" data-id="<?=$lyricsId;?>">
                                    <input type="text" hidden id="beat-id" value="<?= $row['lyrics_id']; ?>">
                                        ...
                                        <div class="product-img">
                                            <a data-bs-toggle="modal" class="beat" data-bs-target="#quickModal" style="cursor:pointer;">
                                                ...
                                                ?>
                                                    <span class="btn btn-success position-absolute m-1 btn-sm"><?= $row['lyrics_category']; ?></span>
                                                <?php
                                                } else {
                                                ?>
                                                    <span class="btn btn-warning text-white position-absolute m-1 btn-sm"><?= $row['lyrics_category']; ?></span>
                                                <?php
                                                }
                                                ?>
                                                <img class="primary-img" src="./admin/Files/lyrics/<?= $row['lyrics_image']; ?>" alt="Product Images">
                                                <img class="secondary-img" src="./admin/Files/lyrics/<?= $row['lyrics_image']; ?>" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                            <ul>
                                            <li hidden>
                                                    ...
                                                    <?php
                                                        if($row['lyrics_basic_amount']!=""){
                                                            ...
                                                            if($test){
                                                                ...
                                                                ?>
                                                                             <li>
                                                        <a class="add-to-cart" data-tippy="Add to cart" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  data-name="<?= $row['lyrics_name'] ?>" data-type="<?=$selector;?>" data-image="<?= $row['lyrics_image']; ?>" data-price="<?= $price; ?>" data-id="<?=$row['lyrics_id'];?>">
                                                            <i class="pe-7s-cart cart-list-active"></i>
                                                        </a>
                                                    </li>
                                                                <?php
                                                        ...
                                                        <a class="add-to-cart" data-tippy="Add to cart" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  data-name="<?= $row['lyrics_name'] ?>" data-type="<?=$selector;?>" data-image="<?= $row['lyrics_image']; ?>" data-price="<?= $price; ?>" data-id="<?=$row['lyrics_id'];?>">
                                                            ...
                                                            ?>
                                                    <li>
                                                        <a class="download add-to-cart" data-tippy="Download" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  href="./admin/Files/<?=$location;?>/<?=$freeFile;?>" download="<?=$row['lyrics_name'];?>.<?php print_r($explode);?>">
                                                      <?php
                                        ...
                                        <div class="product-content">
                                            <a class="product-name w-100" href="shop.html"><?= $row['lyrics_name']; ?></a>
                                            <div class="price-box pb-1 d-flex align-items-center">
                                               <?php
                                                if($row['discount']!=""){
                                                    ?>
                                                     <span class="new-price"><?= $price; ?></span>
                                                     <span style="font-size: 14px;" class="old-price"><del ><?='$'.$row['lyrics_basic_amount'];?></del></span>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <span class="new-price"><?= $price; ?></span>
                                    ...
                                    <div class="product-item " data-type="<?=$location;?>">
                                        ...
                                        <div class="product-img">
                                            <a data-bs-toggle="modal" class="beat" data-bs-target="#quickModal" style="cursor:pointer;">
                                                ...
                                                <img class="primary-img" src="./admin/Files/<?=$location;?>/<?= $row['lyrics_image']; ?>" alt="Product Images">
                                                <img class="secondary-img" src="./admin/Files/<?=$location;?>/<?= $row['lyrics_image']; ?>" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                                <ul>
                                                <li hidden>
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="shop.html"><?= $row['lyrics_name']; ?></a>
                                                ...
                                                <li hidden>
                                                    ...
                                                    <li class="quuickview-btn" data-bs-toggle="modal" data-bs-target="#quickModal">
                                                     ...
                                                     if($test){
                                                            ?>
                                                                       <li>
                                                        <a class="add-to-cart" data-tippy="Add to cart" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  data-name="<?= $row['lyrics_name'] ?>" data-type="lyrics" data-image="<?= $row['lyrics_image']; ?>" data-price="<?= $price; ?>" data-id="<?=$row['lyrics_id'];?>">
                                                            <i class="pe-7s-cart cart-list-active"></i>
                                                        </a>
                                                    </li>
                                                            <?php
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content" id="myTabContent">
                                    ...
                                    <input type="text" hidden id="beat-id" value="<?= $row['song_id']; ?>">
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-add-action">
                                                <ul>
                                                    <li>
                                                        <a data-tippy="Play" class="play" data-id="<?=$songId;?>" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder">
                                                            <i class="entypo-icon-controller-play"></i>
                                                        </a>
                                                    </li>
                                                    <li class="quuickview-btn" data-bs-toggle="modal" data-bs-target="#quickModal">
                    ...
                    <div class="product-item-wrap row">
                            ...
                            ?>
                                <div class="col-xl-3 col-md-4 col-sm-6">
                                    <div class="product-item " data-type="song" data-id="<?=$row['song_id'];?>">
                                        <input type="text" hidden id="beat-id" value="<?= $row['song_id']; ?>">
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-add-action">
                                                <ul>
                                                    ...
                                                    ?>
                                                    <li>
                                                        <a class="download add-to-cart" data-tippy="Download" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"  href="./admin/Files/song/<?=$freeFile;?>" download="<?=$row['song_name'];?>.<?php print_r($explode);?>">
                                    ...
                                    <div class="product-item " data-type="song" data-id="<?=$songId;?>">
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="product-add-action">
                                                <ul>
                                                    <li>
                                                        <a data-tippy="Play" data-id="<?=$row['song_id'];?>" class="play" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder">
                                                            <i class="entypo-icon-controller-play"></i>
                                                        </a>
                                                    </li>
                                                    <li class="quuickview-btn" data-bs-toggle="modal" data-bs-target="#quickModal">
                                            ...
                                            <div class="price-box pb-1 d-flex align-items-center">
                                               <?php
                                                ...
                                                if($row['discount']!=""){
                                                    ?>
                                                     <span class="new-price"><?= $price; ?></span>
                                                     <span style="font-size: 14px;" class="old-price"><del ><?='$'.$row['song_amount'];?></del></span>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <span class="new-price"><?= $price; ?></span>
...
<script>
    let leaseTypes =  {
        basic:["$10.00 - $20.00","Mp3 Version", "5000 Max. Sales ", "Producer / Song writer owns right", "Commercial use", "Non-Exclusive"],

        exclusive: ["$20.00 - $30.00","Mp3 / Wav Version", "10000 Max. Sales ", "Producer / Song Writer owns right", "Commercial use", "Non-Exclusive"],

        premium: ["$30.00 - $50.00","Mp3 / Wav / Stems Version", "Unlimited Max. Sales ", "100% Royalty Free", "Commercial use", "Non-Exclusive"]
